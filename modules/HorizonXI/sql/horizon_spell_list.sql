...
UPDATE `spell_list` SET `CE` = 40, `VE` = 450 WHERE name = 'hojo_ni';
UPDATE `spell_list` SET `CE` = 40, `VE` = 450 WHERE name = 'kurayami_ni';
...
UPDATE `spell_list` SET `content_tag` = NULL WHERE name = 'protectra_v';
UPDATE `spell_list` SET `content_tag` = NULL WHERE name = 'shellra_v';
