-----------------------------------
-- func: createjob
-- desc: Adds all gear appropriate for testing Dynamis/HNM
-- Byakko's Axe, Hiadate 12818, Swift Belt 15457, pole grip 19025, Bomb core 18139,
...
function onTrigger(player, target)
    local itemsToGet =
    {
		...
		15349, 17220, 14764, 13805, 13014, 14260, 13061, 13123, 14806,
		--AF Below
		13961, 14089, 14214, 12638, 12511,
