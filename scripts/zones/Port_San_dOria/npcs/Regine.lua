...
entity.onEventFinish = function(player, csid, option)
    ...
    elseif csid == 510 and option == 1 then
        local stockB =
        {
            ...
            4762, 324 * 0.6, 3,  -- Scroll of Aero
            4757, 1584 * 0.6, 3, -- Scroll of Blizzard
            4843, 4644 * 0.6, 3, -- Scroll of Burn
            4845, 2250 * 0.6, 3, -- Scroll of Choke
            4848, 6366 * 0.6, 3, -- Scroll of Drown
            4752, 837 * 0.6, 3,  -- Scroll of Fire
            4844, 3688 * 0.6, 3, -- Scroll of Frost
            4846, 1827 * 0.6, 3, -- Scroll of Rasp
            4847, 1363 * 0.6, 3, -- Scroll of Shock
            4767, 61 * 0.6, 3,   -- Scroll of Stone
            4772, 3261 * 0.6, 3, -- Scroll of Thunder
            4777, 140 * 0.6, 3   -- Scroll of Water
        }
