...
zones[xi.zone.LABYRINTH_OF_ONZOZO] =
{
    text =
    {
        ...
        SENSE_OMINOUS_PRESENCE   = 7340,  -- You sense an ominous presence...
        REGIME_REGISTERED        = 9396,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM      = 10448, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 10449, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 10450, -- <name> obtains the temporary item: <item>!
