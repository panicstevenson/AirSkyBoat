...
xi.magic.applyResistanceAddEffect = function(player, target, element, effect, bonus, hybridHit)
    ...
    local p = xi.magic.getMagicHitRate(player, target, nil, element, effectRes, bonus, 0, skillchainCount, hybridHit)
...
-- luacheck: ignore 561
xi.magic.getMagicHitRate = function(caster, target, skillType, element, effectRes, bonusAcc, dStat, skillchainCount, hybridHit)
    local magicacc = 0
    local magiceva = 0
    local resMod = 0
