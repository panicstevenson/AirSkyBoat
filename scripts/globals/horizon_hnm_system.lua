...
hxi.hnm.spawnFafnir = function(zone)
    local spawnPoints =
    {
        ...
        [xi.zone.THE_BOYAHDA_TREE] =
        {
            { x = -245.88, y = 9.8, z = -277.1 },
            { x = -199.57, y = 8.72, z = -283.97 },
            { x = -42.01, y = -18.22, z = -162.59 },
            { x = -38.24, y = -19.09, z = -0.77 },
        },
        [xi.zone.DRAGONS_AERY] =
        {
...
hxi.hnm.spawnAddy = function(zone)
    local spawnPoints =
    {
        ...
        [xi.zone.KUFTAL_TUNNEL] =
        {
            { x = 78.24, y = 30,    z = 117.56 },
            { x = -1.03, y = 1,     z = 92.4 },
            { x = -52.8, y = 0,     z = 7.4 },
            { x = 102.5, y = 0.95,  z = -2.04 }
        }
    }
...
hxi.hnm.spawnBehemoth = function(zone)
    local spawnPoints =
    {
        ...
        [xi.zone.QUFIM_ISLAND] =
        {
            { x = 116.87, y = -20,    z = 155.95 },
            { x = 194.06, y = -20,    z = 120.18 },
            { x = 34.07,  y = -19.86, z = -44.86 },
            { x = -199.6, y = -20,    z = -1.57 }
        },
        [xi.zone.ROLANBERRY_FIELDS] =
        {
            { x = -651.9, y = -23.6, z = -257.79 },
            { x = 334.37, y = -0.81, z = 137.57 },
            { x = 282.02, y = -31.3, z = -305.15 },
            { x = 490.95, y = -16.3, z = 8.36 }
        },
        [xi.zone.SAUROMUGUE_CHAMPAIGN] =
        {
            { x = 466.02, y = 17.3,  z = 14.02 },
            { x = 344.9,  y = 40.3,  z = 371.28 },
            { x = 118.45, y = 7.992, z = -196.13 },
            { x = 362.11, y = 7.96,  z = -235.54 }
        },
        [xi.zone.BATALLIA_DOWNS] =
        {
            { x = 69.5,    y = 7.91,  z = -367.73 },
            { x = 173.68,  y = 8.27,  z = -466.81 },
            { x = -623.73, y = -16.0, z = 136.34 },
            { x = -293.13, y = -15.8, z = 380.33 }
        }
    }
