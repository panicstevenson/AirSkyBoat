...
local spawnerMobs =
{
    ...
    [xi.zone.FEIYIN] =
    {
        ...
        {name = "Vampire_Bat", groupId =  4, groupZone = 204, funcLookup = "Default", min = 40, max = 42, xPos =  125.4914, yPos =  -23.5, zPos =   76.8946, rot =  58, respawn = 420, drops =  234, skills =  46, spells =  0},
        {name = "Vampire_Bat", groupId =  4, groupZone = 204, funcLookup = "Default", min = 40, max = 42, xPos =  111.6829, yPos =  -23.5, zPos =     60.59, rot =  46, respawn = 420, drops =  234, skills =  46, spells =  0},
        {name = "Vampire_Bat", groupId =  4, groupZone = 204, funcLookup = "Default", min = 40, max = 42, xPos =  111.8574, yPos =  -23.5, zPos =   40.1518, rot =  57, respawn = 420, drops =  234, skills =  46, spells =  0},
        {name = "Vampire_Bat", groupId =  4, groupZone = 204, funcLookup = "Default", min = 40, max = 42, xPos =  127.0955, yPos =  -23.5, zPos =   43.0564, rot = 243, respawn = 420, drops =  234, skills =  46, spells =  0},
    },
}
