...
local spawnerMobs =
{
    ...
    {
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -185.9534, yPos = 9.9491, zPos = -260.8992, rot = 4.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -187.6409, yPos = 9.9891, zPos = -297.5733, rot = 167.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -210.0007, yPos = 9.8809, zPos = -297.0061, rot = 127.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -212.0160, yPos = 9.8776, zPos = -262.1027, rot = 101.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -228.1155, yPos = 9.8667, zPos = -270.1706, rot = 218.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
        {name = "Blood_Ball", groupId = 24, groupZone = 153, funcLookup = "Default", min = 75, max = 78, xPos = -232.9002, yPos = 9.8640, zPos = -288.4790, rot = 77.0000, respawn = 420, drops = 0, skills = 172, spells = 0},
