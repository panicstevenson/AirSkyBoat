...
local spawnerMobs =
{
    ...
    {
        {name = "Goblin Weaver",     groupId = 13, groupZone = 117, funcLookup = "Default", min = 8, max = 10, xPos = -36.3284, yPos = -15.7060, zPos = -209.9016, rot = 14.0000, respawn = 330, drops = 1186, skills = 133, spells = 3},
        {name = "Killer Bee",        groupId =  9, groupZone = 117, funcLookup = "Default", min = 8, max = 12, xPos = -321.7630, yPos = -8.2048, zPos = 74.4088, rot = 230.0000, respawn = 330, drops = 1439, skills = 48, spells = 0},
        {name = "Strolling Sapling", groupId =  3, groupZone = 117, funcLookup = "Default", min = 7, max = 11, xPos = -75.1870, yPos = 8.0304, zPos = -395.8121, rot = 195.0000, respawn = 330, drops = 2347, skills = 216, spells = 0},
        {name = "Strolling Sapling", groupId =  3, groupZone = 117, funcLookup = "Default", min = 7, max = 11, xPos = -37.0629, yPos = 8.0000, zPos = -361.5097, rot = 91.0000, respawn = 330, drops = 2347, skills = 216, spells = 0},
        {name = "Strolling Sapling", groupId =  3, groupZone = 117, funcLookup = "Default", min = 7, max = 11, xPos = -240.6574, yPos = 0.1920, zPos = 71.4587, rot = 20.0000, respawn = 330, drops = 2347, skills = 216, spells = 0},
    },
}
