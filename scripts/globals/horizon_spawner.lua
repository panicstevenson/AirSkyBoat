...
local spawnerMobs =
{
    ...
    [xi.zone.DANGRUF_WADI] =
    {
        ...
        {name = "Goblin Butcher", groupId = 13, groupZone = 191, funcLookup = "Default", min = 12, max = 16, xPos = -379.6943, yPos = -0.3823, zPos = 289.7022, rot = 223.0000, respawn = 420, drops = 1034, skills = 133, spells = 0},
        {name = "Goblin Butcher", groupId = 13, groupZone = 191, funcLookup = "Default", min = 12, max = 16, xPos = -340.7202, yPos = -0.2313, zPos = 100.5773, rot = 68.0000, respawn = 420, drops = 1034, skills = 133, spells = 0},
        ...
        {name = "Goblin Butcher", groupId = 13, groupZone = 191, funcLookup = "Default", min = 12, max = 16, xPos = -458.1721, yPos = 3.9814, zPos = -89.7890, rot = 195.0000, respawn = 420, drops = 1034, skills = 133, spells = 0},
        ...
        {name = "Goblin Thug", groupId = 7, groupZone = 191, funcLookup = "Default", min = 5, max = 8, xPos = -303.4792, yPos = 4.0221, zPos = -88.4029, rot = 96.0000, respawn = 420, drops = 1173, skills = 133, spells = 0},
        ...
        {name = "Goblin Thug", groupId = 7, groupZone = 191, funcLookup = "Default", min = 5, max = 8, xPos = -361.0223, yPos = 4.0000, zPos = -76.5526, rot = 135.0000, respawn = 420, drops = 1173, skills = 133, spells = 0},
        ...
        {name = "Goblin Tinkerer", groupId = 12, groupZone = 191, funcLookup = "Default", min = 12, max = 16, xPos = -108.9916, yPos = 4.0405, zPos = 203.8396, rot = 89.0000, respawn = 420, drops = 1176, skills = 133, spells = 5},
        {name = "Goblin Tinkerer", groupId = 12, groupZone = 191, funcLookup = "Default", min = 12, max = 16, xPos = -450.6913, yPos = 3.7992, zPos = -140.7938, rot = 127.0000, respawn = 420, drops = 1176, skills = 133, spells = 5},
    ...
    {
        {name = "Demon Pawn", groupId = 2, groupZone = 161, funcLookup = "Default", min = 48, max = 52, xPos = 138.9131, yPos = -24.0284, zPos = -60.5947, rot = 125, respawn = 960, drops = 622, skills = 169, spells = 0},
        {name = "Goblin Reaper", groupId = 12, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -45.5774, yPos = -24.0132, zPos = 97.3717, rot = 238, respawn = 960, drops = 1142, skills = 133, spells = 5},
        {name = "Goblin Trader", groupId = 9, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = 21.9127, yPos = -24.1101, zPos = 68.0333, rot = 154, respawn = 960, drops = 1180, skills = 133, spells = 0},
        {name = "Goblins Bats", groupId = 10, groupZone = 161, funcLookup = "Default", min = 40, max = 42, xPos = 21.9127, yPos = -24.1101, zPos = 68.0333, rot = 154, respawn = 960, drops = 0, skills = 47, spells = 0},
        {name = "Iron Quadav", groupId = 20, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -139.3157, yPos = -31.0000, zPos = 64.8377, rot = 188, respawn = 960, drops = 1378, skills = 202, spells = 4},
        {name = "Orcish Bowshooter", groupId = 13, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = 18.8788, yPos = -20.0000, zPos = -111.3521, rot = 136, respawn = 960, drops = 1877, skills = 189, spells = 0},
        {name = "Orcish Bowshooter", groupId = 13, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = 11.0964, yPos = -20.0000, zPos = -50.7178, rot = 204, respawn = 960, drops = 1877, skills = 189, spells = 0},
        {name = "Orcish Footsoldier", groupId = 14, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -25.4026, yPos = -19.9480, zPos = -50.4831, rot = 253, respawn = 960, drops = 1908, skills = 189, spells = 0},
        {name = "Orcish Gladiator", groupId = 15, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -46.3608, yPos = -24.0040, zPos = -61.8195, rot = 180, respawn = 960, drops = 1912, skills = 189, spells = 0},
        {name = "Orcish Trooper", groupId = 16, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -16.5487, yPos = -19.9799, zPos = -109.9360, rot = 2, respawn = 960, drops = 1946, skills = 189, spells = 4},
        {name = "Orcish Trooper", groupId = 16, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -4.6944, yPos = -20.0000, zPos = -51.8559, rot = 121, respawn = 960, drops = 1946, skills = 189, spells = 4},
        {name = "Spinel Quadav", groupId = 21, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -125.4232, yPos = -24.0000, zPos = 97.9121, rot = 126, respawn = 960, drops = 754, skills = 202, spells = 2},
        {name = "Spinel Quadav", groupId = 21, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -89.5439, yPos = -20.0000, zPos = 84.2730, rot = 187, respawn = 960, drops = 754, skills = 202, spells = 2},
        {name = "Yagudo Conquistador", groupId = 24, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -91.1161, yPos = -20.0000, zPos = -88.6706, rot = 195, respawn = 960, drops = 2702, skills = 270, spells = 7},
        {name = "Yagudo Lutenist", groupId = 25, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -77.0504, yPos = -24.0146, zPos = -61.1110, rot = 4, respawn = 960, drops = 2727, skills = 270, spells = 6},
        {name = "Yagudo Lutenist", groupId = 25, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -92.4758, yPos = -20.0080, zPos = -46.6088, rot = 44, respawn = 960, drops = 2727, skills = 270, spells = 6},
        {name = "Yagudo Prior", groupId = 26, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -138.0622, yPos = -31.7500, zPos = -23.2774, rot = 115, respawn = 960, drops = 2755, skills = 270, spells = 2},
        {name = "Yagudo Prior", groupId = 26, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -126.8332, yPos = -20.0000, zPos = -110.0676, rot = 143, respawn = 960, drops = 2755, skills = 270, spells = 2},
        {name = "Yagudo Prior", groupId = 26, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -104.3166, yPos = -19.9623, zPos = -50.9513, rot = 2, respawn = 960, drops = 2755, skills = 270, spells = 2},
        {name = "Yagudo Zealot", groupId = 23, groupZone = 161, funcLookup = "Default", min = 47, max = 49, xPos = -150.5464, yPos = -20.0000, zPos = -102.1010, rot = 58, respawn = 960, drops = 2765, skills = 270, spells = 0},
    },
}
