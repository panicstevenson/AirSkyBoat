...
ability_object.onUseAbility = function(pet, target, skill, action)
    ...
    local dmgmod = xi.mobskills.mobBreathMove(pet, target, 0.185, pet:getMainLvl() * 15, xi.magic.ele.LIGHTNING) -- Works out to (hp/6) + 15, as desired
    ...
    target:addStatusEffectEx(xi.effect.ELEMENTAL_EVASION_DOWN, xi.effect.NONE, 6, 0, 15, 1, 0, 0, xi.effectFlag.NO_LOSS_MESSAGE, true)
