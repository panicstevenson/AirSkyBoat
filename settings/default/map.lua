...
xi.settings.map =
{
    ...
    MOB_ADDITIONAL_TIME_TO_DEAGGRO = 1800,
    ...
    ANTICHEAT_CRAFT_SWAP_TIME        = 5,    -- Time in seconds expected for a player to switch crafting recipes normally.
    ...
    ANTICHEAT_CRAFT_TIME_AVG         = 0.25, -- Difference in time allowed between synths on average in seconds.
    ...
    WARDROBE_CITY_ONLY = false, -- true = move gear only in cities | false = move gear anywhere
