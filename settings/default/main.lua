...
xi.settings.main =
{
    ...
    -- LIMBUS SETTINGS
    COSMO_CLEANSE_BASE_COST     = 50000,    -- Base gil cost for a Cosmo Cleanse from Sagheera
    ...
    STARLIGHT_YEAR_ROUND            = 1,  -- Set to 1 to have the Starlight Celebration initialize outside of normal times.
