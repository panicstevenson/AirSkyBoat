...
CInventorySizePacket::CInventorySizePacket(CCharEntity* PChar)
{
    ...
    ref<uint8>(0x28) = charutils::hasStorageAccess(PChar) ? 1 + PChar->getStorage(LOC_STORAGE)->GetBuff() : 0x00;
    ...
    ref<uint8>(0x34) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE)->GetBuff() : 0x00;
    ref<uint8>(0x36) = 1 + PChar->getStorage(LOC_MOGSAFE2)->GetBuff();
    ref<uint8>(0x38) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE2)->GetBuff() : 0x00;
    ref<uint8>(0x3A) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE3)->GetBuff() : 0x00;
    ref<uint8>(0x3C) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE4)->GetBuff() : 0x00;
    ref<uint8>(0x3E) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE5)->GetBuff() : 0x00;
    ref<uint8>(0x40) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE6)->GetBuff() : 0x00;
    ref<uint8>(0x42) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE7)->GetBuff() : 0x00;
    ref<uint8>(0x44) = charutils::hasWardrobeAccess(PChar) ? 1 + PChar->getStorage(LOC_WARDROBE8)->GetBuff() : 0x00;
