...
namespace charutils
{
    ...
    bool hasStorageAccess(CCharEntity* PChar);                 // true if have access, false otherwise.
    bool hasWardrobeAccess(CCharEntity* PChar);                // true if have access, false otherwise.
